...
import{ ImageBackground, Dimensions, View, TouchableOpacity, ScrollView, AsyncStorage, FlatList, Image, SafeAreaView} from 'react-native';
...
<Grid>
    ...
    <Text style={{fontSize: 15, color: '#fff', fontWeight: 'bold'}}>{Strings.ST16}</Text>
    </View>
    </TouchableOpacity>
